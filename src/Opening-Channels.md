...
**Important note**:
* Channel reserve amounts differ among LSPs. Channel reserve refers to the funds locked in a channel and that can't be transferred until it is closed. While Breez sets the channel reserve to a near-dust value of 600 sats on its default channels, other providers will probably use the default setting of 1% of a channel's capacity. This will be reflected in the Breez UI. 
