...
Further, [Boltz](https://boltz.exchange/), the reverse swap provider, charges a fixed service fee of 0.4% plus an additional mining fee, which is variable based on the current bitcoin mempool usage.
